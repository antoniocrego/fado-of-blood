...
public class AIMaleHuskCombatManager : AICharacterCombatManager
{
    [Header("Damage Colliders")]
    [SerializeField] MaleHuskHandDamageCollider rightHandDamageCollider;
    [SerializeField] MaleHuskHandDamageCollider leftHandDamageCollider;
